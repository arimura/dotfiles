...
you should place your code here."
  ...
  (defun previous-other-window ()
    (interactive)
      (other-window -1))
  (define-key global-map (kbd "M-{") 'previous-other-window)
